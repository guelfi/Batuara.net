...
// Cores principais da Casa Batuara (consistente com o site público)
const batuaraColors = {
  primary: {
    main: '#1976d2', // Azul de Yemanjá
    light: '#42a5f5',
    dark: '#1565c0',
    contrastText: '#ffffff',
  },
  secondary: {
    main: '#f57c00', // Laranja de Iansã
    light: '#ffb74d',
    dark: '#ef6c00',
    contrastText: '#ffffff',
  },
  success: {
    main: '#388e3c', // Verde de Oxóssi
    light: '#66bb6a',
    dark: '#2e7d32',
    contrastText: '#ffffff',
  },
  warning: {
    main: '#f9a825', // Amarelo de Oxum
    light: '#ffcc02',
    dark: '#f57f17',
    contrastText: '#000000',
  },
